...
namespace Moen.KanColle.Dentan.Data
{
    ...
    {
        public static ReadOnlyDictionary<int, Experience> Ship { get; private set; }
        public static ReadOnlyDictionary<int, Experience> Admiral { get; private set; }

        static ExperienceTable()
        {
            Ship = new ReadOnlyDictionary<int, Experience>(new Dictionary<int, Experience>()
            {
            ...
            Admiral = new ReadOnlyDictionary<int, Experience>(new Dictionary<int, Experience>()
            {
                { 1, new Experience(1, 0, 100) }, 
				{ 2, new Experience(2, 100, 200) }, 
				{ 3, new Experience(3, 300, 300) }, 
